...
tags: [DFT, CIMPA, TUK, Materials Science]
---
...
* **Host Group:** [Materials Modelling Group](https://materials-modelling-group.github.io/)
...
1.  **Fundamental Theory:** Moving from the many-body Schrödinger equation to Kohn-Sham auxiliary systems.
2.  **Advanced Approximations:** Exploring LDA, GGA, Hybrids, and Meta-GGA functionals.
3.  **Dynamic Properties:** Introduction to Time-Dependent DFT (TDDFT) and Linear Response.
4.  **Hands-on Logic:** Using the **IDEA code** for 1D model systems to visualize exact vs. approximate quantum mechanics.
...
> [Apply via the Official CIMPA Website](https://www.cimpa.info/)

Additional pedagogical materials, including recorded lecture videos from our previous sessions, are available for reference at the [Yambo e-learning portal](https://elearning.yambo-code.eu/).
...
<div style="display: flex; justify-content: space-around; align-items: center; margin-top: 30px;">
    <img src="/assets/images/pictures/tuk-logo.webp" width="100">
    <img src="/assets/images/pictures/logos/cnrs.png" width="100">
</div>
